              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Se esiste una descrizione lunga, la mostriamo formattata (Markdown)
                    // altrimenti usiamo la descrizione breve come fallback.
                    if (painting.detailDescription != null &&
                        painting.detailDescription!.trim().isNotEmpty)
                      MarkdownBody(
                        data: painting.detailDescription!,
                        selectable: true,
